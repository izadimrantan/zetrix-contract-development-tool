...
const Utils = {
     ...
     * 256-bit comparison
     *
     * @param {string} x - Left value.
     * @param {string} y - Right value.
     ...
     * @param {string} dataType - The data type of data, integer, optional field, defaults to 0. 0: base16 encoded string, such as "61626364"; 1: ordinary original string, such as "abcd"; 2: base64 encoded string, Such as "YWJjZA==". If hashing binary data, it is recommended to use base16 or base64 encoding.
     ...
     * @param {string} blobDataType - Data type of blobData, integer, optional field, default is 0. 0: base16 encoded string, such as "61626364"; 1: ordinary original string, such as "abcd"; 2: base64 encoded string, Such as "YWJjZA==". If verifying binary data, it is recommended to use base16 or base64 encoding.
