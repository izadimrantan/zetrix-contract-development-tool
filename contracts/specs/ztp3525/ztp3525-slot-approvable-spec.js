...
const ZTP3525Inst = new ZTP3525SlotApprovable();
...
function init() {
    ...
    Utils.assert(implementsInterface(ZTP3525Inst, IZTP3525SlotApprovable), "ZTP3525 class does not implement IZTP3525SlotApprovable");
    return true;
}
...
function main(input_str) {
    let funcList = {
        ...
        'burn': burn,
        'burn': burnValue,
        'setApprovalForSlot': ZTP3525Inst.setApprovalForSlot
    };
...
function query(input_str) {
    let funcList = {
        ...
        'isApprovedForSlot': ZTP3525Inst.isApprovedForSlot
    };
    let inputObj = JSON.parse(input_str);
    Utils.assert(funcList.hasOwnProperty(inputObj.method) && typeof funcList[inputObj.method] === 'function', 'Cannot find func:' + inputObj.method);
