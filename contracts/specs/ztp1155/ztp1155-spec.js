...
function mint(paramObj) {
    ZTP1155Inst.mint(paramObj.to, paramObj.id, paramObj.value);
}

function mintBatch(paramObj) {
    ZTP1155Inst.mint(paramObj.to, paramObj.ids, paramObj.values);
}

function burn(paramObj) {
    ZTP1155Inst.burn(paramObj.to, paramObj.id, paramObj.value);
}

function burnBatch(paramObj) {
    ZTP1155Inst.burnBatch(paramObj.to, paramObj.ids, paramObj.values);
}

function init() {

    ZTP1155Inst.init('https://example.com/');
